...
#   white = 1.0f = 0x3F800000, black = 0.0f = 0x00000000
#
# Architecture note: ALU/FPU/IMM run for ALL threads regardless of exec_mask.
# STORE respects exec_mask: each path's STORE only writes to its threads' addresses.
...
LDI_LO v11.xyzw, 0x0000 # v11 = 0.0f (black)
STORE v11, 0x0000(v2)   # exec_mask = odd threads
SYNC

# ---- White path (even = white = taken) ----
white:
LDI_LO v11.xyzw, 0x0000 # lower half = 0
LDI_HI v11.xyzw, 0x3F80 # v11 = 0x3F800000 = 1.0f (white)
STORE v11, 0x0000(v2)   # exec_mask = even threads
SYNC
